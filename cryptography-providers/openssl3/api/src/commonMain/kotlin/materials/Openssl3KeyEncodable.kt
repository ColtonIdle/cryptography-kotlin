...
internal abstract class Openssl3PrivateKeyEncodable<KF : MaterialFormat>(
...
internal abstract class Openssl3PublicKeyEncodable<KF : MaterialFormat>(
    key: CPointer<EVP_PKEY>,
) : Openssl3KeyEncodable<KF>(key) {
...
internal abstract class Openssl3KeyEncodable<KF : MaterialFormat>(
    ...
    override fun encoder(): MaterialSelfEncoder<KF> = object : MaterialSelfEncoder<KF> {
        override fun encodeTo(format: KF): ByteArray = memScoped {
